...
public class ApoDiceUserlevelsLoad {
	...
	private static ApoDiceUserlevelsLoad singleInstance = new ApoDiceUserlevelsLoad();

	public static ApoDiceUserlevelsLoad getInstance() {
		if (null == singleInstance) {
			singleInstance = new ApoDiceUserlevelsLoad();
		}
		return singleInstance;
	}

	private ApoDiceUserlevelsLoad() {
	...
	public boolean save(String level) {
		if (ApoDice.isOnline()) {
			try {
				...
				url = new URL(ApoDiceConstants.USERLEVELS_SAVEPHP);
	...
	public boolean load() {
		...
		if (ApoDice.isOnline()) {
			try {
				...
				url = new URL(ApoDiceConstants.USERLEVELS_GETPHP);
				urlConn = url.openConnection();
