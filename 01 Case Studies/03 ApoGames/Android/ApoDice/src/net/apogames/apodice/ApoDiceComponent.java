...
public abstract class ApoDiceComponent extends BitsScreen implements BitsTouchListener, BitsKeyListener {
	...
	private ApoDiceModel model;
	
	protected ApoDiceComponent(int id) {
		super(id);
	}
	...
	public ApoDiceModel getModel() {
		return this.model;
	}

	public void setModel(ApoDiceModel model) {
		this.model = model;
	}
