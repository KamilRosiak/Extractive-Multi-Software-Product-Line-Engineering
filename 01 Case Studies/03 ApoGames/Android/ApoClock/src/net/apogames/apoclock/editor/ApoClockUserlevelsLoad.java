...
public class ApoClockUserlevelsLoad {
	...
	private static ApoClockUserlevelsLoad singleInstance = new ApoClockUserlevelsLoad();

	public static ApoClockUserlevelsLoad getInstance() {
		if (null == singleInstance) {
			singleInstance = new ApoClockUserlevelsLoad();
		}
		return singleInstance;
	}

	private ApoClockUserlevelsLoad() {
	...
	public boolean save(String level) {
		if (ApoClock.isOnline()) {
			try {
				...
				url = new URL(ApoClockConstants.USERLEVELS_SAVEPHP);
	...
	public boolean load() {
		...
		if (ApoClock.isOnline()) {
			try {
				...
				url = new URL(ApoClockConstants.USERLEVELS_GETPHP);
				urlConn = url.openConnection();
