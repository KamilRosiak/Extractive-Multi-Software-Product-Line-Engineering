...
public class ApoSnakeUserlevelsLoad {
	...
	private static ApoSnakeUserlevelsLoad singleInstance = new ApoSnakeUserlevelsLoad();

	public static ApoSnakeUserlevelsLoad getInstance() {
		if (null == singleInstance) {
			singleInstance = new ApoSnakeUserlevelsLoad();
		}
		return singleInstance;
	}

	private ApoSnakeUserlevelsLoad() {
	...
	public boolean save(String level) {
		if (ApoSnake.isOnline()) {
			try {
				...
				url = new URL(ApoSnakeConstants.USERLEVELS_SAVEPHP);
	...
	public boolean load() {
		...
		if (ApoSnake.isOnline()) {
			try {
				...
				url = new URL(ApoSnakeConstants.USERLEVELS_GETPHP);
				urlConn = url.openConnection();
