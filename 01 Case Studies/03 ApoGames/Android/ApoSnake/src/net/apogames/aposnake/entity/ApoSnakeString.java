...
import net.apogames.aposnake.game.ApoSnakeMenu;
import net.gliblybits.bitsengine.render.BitsGraphics;

public class ApoSnakeString extends ApoSnakeEntity {
	...
	public ApoSnakeString(float x, float y, float width, String s, boolean bWithBackground, int timeDecrease, boolean bFade) {
	...
	public void render(final BitsGraphics g, int changeX, int changeY) {
		if (this.isVisible()) {
			...
			int w = (int)(ApoSnakeMenu.font.getLength(s) + 10);
			int h = ApoSnakeMenu.font.mCharCellHeight;
			...
			g.setColor(0, 0, 0, this.invisible);
			g.drawText(s, ApoSnakeMenu.font, x, y - h);
		}
	}
