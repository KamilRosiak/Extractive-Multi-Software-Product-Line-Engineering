...
public class ApoMonoUserlevelsLoad {
	...
	private static ApoMonoUserlevelsLoad singleInstance = new ApoMonoUserlevelsLoad();

	public static ApoMonoUserlevelsLoad getInstance() {
		if (null == singleInstance) {
			singleInstance = new ApoMonoUserlevelsLoad();
		}
		return singleInstance;
	}

	private ApoMonoUserlevelsLoad() {
	...
	public boolean save(String level) {
		if (ApoMonoActivity.isOnline()) {
			try {
				...
				url = new URL(ApoMonoConstants.USERLEVELS_SAVEPHP);
	...
	public boolean load() {
		...
		if (ApoMonoActivity.isOnline()) {
			try {
				...
				url = new URL(ApoMonoConstants.USERLEVELS_GETPHP);
				urlConn = url.openConnection();
