...
public abstract class ApoMonoComponent extends BitsScreen implements BitsPointerListener, BitsKeyListener {
	...
	private ApoMonoModel model;
	
	protected ApoMonoComponent(int id) {
		super(id);
	}
