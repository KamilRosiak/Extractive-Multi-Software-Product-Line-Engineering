...
public abstract class ApoSubGame extends Thread {
	...
	private BufferedImage offscreenImage = new BufferedImage(ApoConstants.GAME_WIDTH, ApoConstants.GAME_HEIGHT, BufferedImage.TYPE_INT_RGB);
	...
	public void run() {
		...
		long msPerTickThink = (long)(1000.0 / (double)(ApoConstants.FPS_THINK));
		long msPerTickRender = (long)(1000.0 / (double)(ApoConstants.FPS_RENDER));
		this.frames = 0;
		...
		while (this.isRunning) {
			...
			// leg den Thread für 10 Millisekunden schlafen
			try {
				Thread.sleep(10);
