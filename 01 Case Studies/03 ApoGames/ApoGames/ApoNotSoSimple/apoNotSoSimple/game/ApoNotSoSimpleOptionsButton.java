 ...
 * @author Dirk Aporius
 */
public class ApoNotSoSimpleOptionsButton extends ApoButton {
	
	private boolean bActive;
	
	public ApoNotSoSimpleOptionsButton(BufferedImage iImage, float x, float y, float width, float height) {
		this(iImage, (int)x, (int)y, (int)width, (int)height, "", false);
	}
	
	public ApoNotSoSimpleOptionsButton(BufferedImage iImage, float x, float y, float width, float height, String description, boolean bActive) {
