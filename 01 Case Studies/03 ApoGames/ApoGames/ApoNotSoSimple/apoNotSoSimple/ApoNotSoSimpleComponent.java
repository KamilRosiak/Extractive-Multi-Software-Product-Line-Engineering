 ...
 *
 */
public abstract class ApoNotSoSimpleComponent extends ApoSubGame {

	/** Objekt, mit dem mit bestimmten Werten Bilder erstellt und geladen werden können */
	private ApoNotSoSimpleImages images;
	 ...
	 */
	public ApoNotSoSimpleComponent(ApoScreen screen) {
		super(screen);
	}
	...
	protected void load() {
		if (this.images == null) {
			this.images = new ApoNotSoSimpleImages();
		}
	...
	public boolean isShowFPS() {
		return ApoNotSoSimpleConstants.FPS;
	}
	...
	public void setShowFPS(boolean showFPS) {
		ApoNotSoSimpleConstants.FPS = showFPS;
	}
	 ...
	 */
	public final ApoNotSoSimpleImages getImages() {
		return this.images;
	}
