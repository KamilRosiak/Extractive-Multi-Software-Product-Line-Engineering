 ...
 *
 */
public abstract class ApoPongBeatComponent extends ApoSubGame {

	/** Objekt, mit dem mit bestimmten Werten Bilder erstellt und geladen werden können */
	private ApoPongBeatImages images;
	 ...
	 */
	public ApoPongBeatComponent(ApoScreen screen) {
		super(screen);
	}
	...
	protected void load() {
		if (this.images == null) {
			this.images = new ApoPongBeatImages();
		}
		
		if (this.sounds == null) {
			try {
				this.sounds = new ApoSounds();
				this.sounds.loadSound("a", "/sounds/Piano_A.wav");
				this.sounds.loadSound("h", "/sounds/Piano_B.wav");
				this.sounds.loadSound("b", "/sounds/Piano_Bb.wav");
				this.sounds.loadSound("c", "/sounds/Piano_C.wav");
				this.sounds.loadSound("c#", "/sounds/Piano_C_.wav");
				this.sounds.loadSound("d", "/sounds/Piano_D.wav");
				this.sounds.loadSound("e", "/sounds/Piano_E.wav");
				this.sounds.loadSound("eb", "/sounds/Piano_Eb.wav");
				this.sounds.loadSound("d#", "/sounds/Piano_Eb.wav");
				this.sounds.loadSound("f", "/sounds/Piano_F.wav");
				this.sounds.loadSound("f#", "/sounds/Piano_F_.wav");
				this.sounds.loadSound("g", "/sounds/Piano_G.wav");
				this.sounds.loadSound("g#", "/sounds/Piano_G_.wav");
				this.sounds.loadSound("pong", "/sounds/Pong_Blip.wav");
				this.sounds.loadSound("bounce", "/sounds/Pong_Bounce.wav");
				this.sounds.loadSound("death", "/sounds/Pong_Death.wav");
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public boolean isShowFPS() {
		return ApoPongBeatConstants.FPS;
	}
	...
	public void setShowFPS(boolean showFPS) {
		ApoPongBeatConstants.FPS = showFPS;
	}
	 ...
	 */
	public final ApoPongBeatImages getImages() {
		return this.images;
	}
