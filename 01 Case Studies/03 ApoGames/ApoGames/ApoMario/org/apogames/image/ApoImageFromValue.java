...
public class ApoImageFromValue {
	 ...
	 * @return liefert ein dreigeteiltes Bild zurück mit übergebener Breite, Höhe, Farben und Text zurück
	 */
	public BufferedImage getButtonImageColor(int width, int height, String text, Color background, Color font, Color border, Color over, Color pressed, Font writeFont, int round) {
		...
		for ( int i = 0; i < 3; i++ ) {
			...
			g.drawString(text, i*x + x/2 - w/2, iButton.getHeight()/2 + realHeight/2);
