...
public class ApoImageScale {
	...
	public BufferedImage getDoubleScaledImage( BufferedImage srcImage ) {
		...
		BufferedImage image = GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice().getDefaultConfiguration().createCompatibleImage(width * 2, height * 2, BufferedImage.TYPE_INT_ARGB_PRE);
	...
	public BufferedImage getTrippleScaledImage( BufferedImage srcImage ) {
		...
		BufferedImage image = GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice().getDefaultConfiguration().createCompatibleImage(width * 3, height * 3, BufferedImage.TYPE_INT_ARGB_PRE);
