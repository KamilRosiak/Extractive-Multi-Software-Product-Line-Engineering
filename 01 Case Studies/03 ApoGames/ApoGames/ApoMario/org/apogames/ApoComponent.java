...
public abstract class ApoComponent extends JComponent implements
	 ...
	 */
	public ApoComponent(boolean bMouse, boolean bKey, int ticks, int gameWidth, int gameHeight, boolean bStrategy) {
	 ...
	 * @param wait_time = alle wieviel Millisekunden soll nachgedacht und gezeichnet werden
	 */
	public ApoComponent(boolean bMouse, boolean bKey, int ticks_think, int ticks_render, int gameWidth, int gameHeight, boolean bStrategy) {
	 ...
	 */
	public ApoComponent(boolean bMouse, boolean bKey, int ticks_think, int ticks_render, boolean bTimer, int gameWidth, int gameHeight, boolean bStrategy) {
		super();
