 ...
 * @author Dirk Aporius
 */
public class ApoMarioPlayerDrawRect extends ApoMarioPlayerDraw {
	...
	public ApoMarioPlayerDrawRect(float x, float y, float width, float height, boolean bFill, int time, Color color) {
		super(time, color);
		this.x = x;
		this.y = y;
		this.width = width;
