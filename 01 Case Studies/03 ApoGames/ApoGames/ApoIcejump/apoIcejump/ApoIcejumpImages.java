...
public class ApoIcejumpImages {
	...
	public BufferedImage getLogo(int width, int height) {
		BufferedImage iLogo = GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice().getDefaultConfiguration().createCompatibleImage(width, height, BufferedImage.TYPE_INT_ARGB_PRE);
		Graphics2D g	= (Graphics2D)iLogo.getGraphics();

		g.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
		
		g.setColor(Color.YELLOW);
		g.fillRoundRect((int)(0), (int)(0), (int)(width - 1), (int)(height - 1), 15, 15);
		g.setColor(Color.BLACK);
		g.drawRoundRect((int)(0), (int)(0), (int)(width - 1), (int)(height - 1), 15, 15);
		Stroke stroke = g.getStroke();
		g.setStroke(new BasicStroke(2));
		g.drawLine((int)(0 + width/2 - 4), (int)(0 + height/2 - 5), (int)(0 + width/2 - 4), (int)(0 + height/2));
		g.drawLine((int)(0 + width/2 + 3), (int)(0 + height/2 - 5), (int)(0 + width/2 + 3), (int)(0 + height/2));
		g.setStroke(stroke);
