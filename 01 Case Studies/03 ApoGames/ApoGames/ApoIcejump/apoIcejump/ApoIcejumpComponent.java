 ...
 *
 */
public abstract class ApoIcejumpComponent extends ApoComponentBufferedStrategy {

	private static final long serialVersionUID = 1L;

	/** Angabe, wo die Levels für das Applet liegen */
	public static final String APPLET_LEVEL = "http://apo-games.de/apoIcejumpReloaded/";
	/** A FileChooser */
	...
	private ApoIcejumpImages images;
	...
	public ApoIcejumpComponent() {
		super(true, true, ApoIcejumpConstants.FPS_THINK, ApoIcejumpConstants.FPS_RENDER, ApoIcejumpConstants.GAME_WIDTH, ApoIcejumpConstants.GAME_HEIGHT);
	}
	...
	public void init() {
		...
		if (this.images == null) {
			this.images = new ApoIcejumpImages();
			
			ApoIcejumpImageContainer.init(this.images);
		}
	 ...
	 */
	public ApoIcejumpImages getImages() {
		return this.images;
	}
	 ...
	 */
	public void setImages(ApoIcejumpImages images) {
		this.images = images;
	}
