	...
	public void render(Graphics2D g, int changeX, int changeY) {
		if (super.isBVisible()) {
			if (super.getIBackground() != null) {
				g.drawImage(super.getIBackground().getSubimage((int)(this.getFrame() * this.getWidth()), 0, (int)this.getWidth(), (int)this.getHeight()), (int)(this.getX() + changeX), (int)(this.getY() + changeY), null);
			}
			if (super.isBSelect()) {
