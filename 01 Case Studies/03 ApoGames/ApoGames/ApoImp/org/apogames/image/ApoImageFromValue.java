...
public class ApoImageFromValue {
	 ...
	 * @param width : Breite
	 */
	public void drawString(final Graphics2D g, final String s, final int x, final int y, final int width) {
	 ...
	 */
	public BufferedImage getImageFromPath(String path, boolean bLoad, boolean bWithAlpha) {
		return this.image.getPic(path, bLoad, bWithAlpha);
	}	
	 ...
	 */
	public BufferedImage getAndMakeIBackground(final int width, final int height) {
	 ...
	 */
	public BufferedImage getAndMakeIBackground(final int width, final int height, final Color c) {
	 ...
	 */
	public BufferedImage getButtonImage(final int width, final int height, final String text, final int round) {
	 ...
	 */
	public BufferedImage getButtonImage(final int width, final int height, final String text, final Color background, final Color font, final Color border) {
	 ...
	 * @return liefert ein dreigeteiltes Bild zurück mit übergebener Breite, Höhe, Farben und Text zurück
	 */
	public BufferedImage getButtonImage(final int width, final int height, final String text, final Color background, final Color font, final Color border, final int round) {
	...
	public BufferedImage getButtonImage( int width, int height, String text, Color background, Color font, Color border, Color over, Color pressed, Font writeFont, int round ) {
		BufferedImage iButton = new BufferedImage(width,height,BufferedImage.TYPE_INT_ARGB_PRE);
	 ...
	 */
	public static BufferedImage getImageCopy(final BufferedImage iImage) {
