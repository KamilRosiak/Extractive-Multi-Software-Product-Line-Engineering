...
public class ApoImpUserlevelsLoad {
	...
	private static ApoImpUserlevelsLoad singleInstance = new ApoImpUserlevelsLoad();

	public static ApoImpUserlevelsLoad getInstance() {
		if (null == singleInstance) {
			singleInstance = new ApoImpUserlevelsLoad();
		}
		return singleInstance;
	}

	private ApoImpUserlevelsLoad() {
	...
	public boolean save(String level) {
		if (ApoConstants.B_ONLINE) {
			try {
				...
				url = new URL(ApoImpConstants.USERLEVELS_SAVEPHP);
	...
	public boolean load() {
		...
		if (ApoConstants.B_ONLINE) {
			try {
				...
				url = new URL(ApoImpConstants.USERLEVELS_GETPHP);
				urlConn = url.openConnection();
