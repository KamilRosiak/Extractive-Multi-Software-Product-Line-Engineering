...
public class ApoScreen {
	...
	public void initApplet() {
		if ((this.parent != null) && (this.parent instanceof JApplet)) {
			...
			Canvas window = null;
			if (ApoMarioConstants.BUFFER_STRATEGY) {
	...
	private void initFullscreen() {
		...
		DisplayMode display = new DisplayMode(this.displayConfiguration.getWidth(), this.displayConfiguration.getHeight(), this.displayConfiguration.getDepth(), ApoMarioConstants.FPS_RENDER);
