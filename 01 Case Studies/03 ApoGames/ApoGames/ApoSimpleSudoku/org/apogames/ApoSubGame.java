...
public abstract class ApoSubGame extends Thread {
	...
	private BufferedImage offscreenImage = new BufferedImage(ApoSimpleSudokuConstants.GAME_WIDTH, ApoSimpleSudokuConstants.GAME_HEIGHT, BufferedImage.TYPE_INT_RGB);
	...
	public void run() {
		...
		long msPerTickThink = (long)(1000.0 / (double)(ApoSimpleSudokuConstants.FPS_THINK));
		long msPerTickRender = (long)(1000.0 / (double)(ApoSimpleSudokuConstants.FPS_RENDER));
		this.frames = 0;
