...
public class ApoScreen {
	...
	public void initApplet() {
		if ((this.parent != null) && (this.parent instanceof JApplet)) {
			...
			Canvas window = null;
			if (ApoSimpleSudokuConstants.BUFFER_STRATEGY) {
				window = new Canvas(this.graphicConfiguration);
			} else {
	...
	private void initFullscreen() {
		...
		DisplayMode display = new DisplayMode(this.displayConfiguration.getWidth(), this.displayConfiguration.getHeight(), this.displayConfiguration.getDepth(), ApoSimpleSudokuConstants.FPS_RENDER);
