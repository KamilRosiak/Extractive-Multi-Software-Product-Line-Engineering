 ...
 *
 */
public abstract class ApoSnakeComponent extends ApoSubGame {

	/** Objekt, mit dem mit bestimmten Werten Bilder erstellt und geladen werden können */
	private ApoSnakeImages images;
	 ...
	 */
	public ApoSnakeComponent(ApoScreen screen) {
		super(screen);
	}
	...
	protected void load() {
		if (this.images == null) {
			this.images = new ApoSnakeImages();
		}
	 ...
	 */
	public final ApoSnakeImages getImages() {
		return this.images;
	}
