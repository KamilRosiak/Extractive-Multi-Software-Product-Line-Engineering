...
public class ApoSnakeImages {

	/** HilfsObjekt, um vorgefertigte Bilder zu laden (z.B. für Buttons) */
	private ApoImageFromValue image;
	
	private static ApoSnakeImages INSTANCE;
	
	public static ApoSnakeImages getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new ApoSnakeImages();
		}
		return INSTANCE;
	}
	
	public ApoSnakeImages() {
