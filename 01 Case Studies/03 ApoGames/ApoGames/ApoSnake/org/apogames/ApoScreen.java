...
public class ApoScreen {
	...
	private void initFullscreen() {
		this.frame = new JFrame(this.title);
		java.awt.Window window = new java.awt.Window(this.frame);
		...
		window.getGraphicsConfiguration().getDevice().setDisplayMode(display);
	...
	public void addMouse(ApoMouse mouse) {
		...
		this.component.addMouseWheelListener(mouse);
		this.component.requestFocus();
	}
}
