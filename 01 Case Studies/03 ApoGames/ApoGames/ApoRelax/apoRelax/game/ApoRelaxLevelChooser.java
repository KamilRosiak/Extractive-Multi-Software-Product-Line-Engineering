...
public class ApoRelaxLevelChooser extends ApoRelaxState {
	...
	public ApoRelaxLevelChooser(ApoRelaxPanel game) {
		super(game);
	...
	public void init() {
		if (this.buttons == null) {
			...
			for (int i = 0; i < 12; i++) {
				...
				x += 95;
				if (x + width >= ApoRelaxConstants.GAME_WIDTH - 20) {
					x = 20;
					y += 95;
					if ((y > 100) && (y < 200)) {
						y = 320;
		...
		if (this.iBackground == null) {
			...
			String s = "ApoRelax - LevelChooser";
	...
	public void mouseButtonFunction(String function) {
		if (function.equals(ApoRelaxLevelChooser.MENU)) {
			this.getGame().setMenu();
		}
	}
