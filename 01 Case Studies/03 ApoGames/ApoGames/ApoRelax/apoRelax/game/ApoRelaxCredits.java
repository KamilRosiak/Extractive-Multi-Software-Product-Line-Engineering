...
public class ApoRelaxCredits extends ApoRelaxState {
	...
	public ApoRelaxCredits(ApoRelaxPanel game) {
		super(game);
	...
	public void init() {
		if (this.iBackground == null) {
			...
			s = "Basic Game idea by Randomdragoon";
			w = g.getFontMetrics().stringWidth(s);
			g.drawString(s, this.iBackground.getWidth()/2 - w/2, h/2 + 70);
			
			s = "http://jayisgames.com/games/not-to-scale/";
			w = g.getFontMetrics().stringWidth(s);
	...
	public void mouseButtonFunction(String function) {
		if (function.equals(ApoRelaxCredits.MENU)) {
			this.getGame().setMenu();
		}
	}
