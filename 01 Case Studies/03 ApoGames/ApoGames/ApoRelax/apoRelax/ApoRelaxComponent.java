 ...
 *
 */
public abstract class ApoRelaxComponent extends ApoSubGame {

	/** Objekt, mit dem mit bestimmten Werten Bilder erstellt und geladen werden können */
	private ApoRelaxImages images;
	 ...
	 */
	public ApoRelaxComponent(ApoScreen screen) {
		super(screen);
	}
	...
	protected void load() {
		if (this.images == null) {
			this.images = new ApoRelaxImages();
		}
	 ...
	 */
	public final ApoRelaxImages getImages() {
		return this.images;
	}
