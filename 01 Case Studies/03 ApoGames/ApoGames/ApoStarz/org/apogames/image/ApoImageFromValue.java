...
public class ApoImageFromValue {
	...
	public BufferedImage getButtonImage( int width, int height, String text ) {
		return this.getButtonImage( width, height, text, Color.black, Color.white, Color.gray );
	}
	...
	public BufferedImage getButtonImage( int width, int height, String text, Color background, Color font, Color border, Color over, Color pressed ) {
		return this.getButtonImage(width, height, text, background, font, border, over, pressed, new Font( "Dialog", Font.BOLD, 15 ));
	}
