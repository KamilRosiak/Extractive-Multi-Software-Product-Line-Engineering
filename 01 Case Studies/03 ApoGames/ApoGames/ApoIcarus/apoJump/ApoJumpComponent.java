 ...
 *
 */
public abstract class ApoJumpComponent extends ApoSubGame {

	/** Objekt, mit dem mit bestimmten Werten Bilder erstellt und geladen werden können */
	private ApoJumpImages images;
	 ...
	 */
	public ApoJumpComponent(ApoScreen screen) {
		super(screen);
	}
	 ...
	 */
	public final ApoJumpImages getImages() {
		return this.images;
	}
