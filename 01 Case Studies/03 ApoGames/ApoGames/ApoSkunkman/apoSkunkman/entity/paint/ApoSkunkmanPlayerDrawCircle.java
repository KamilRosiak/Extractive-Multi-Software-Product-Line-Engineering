 ...
 * @author Dirk Aporius
 */
public class ApoSkunkmanPlayerDrawCircle extends ApoSkunkmanPlayerDraw {
	...
	public ApoSkunkmanPlayerDrawCircle(float x, float y, float radius, boolean bFill, int time, Color color) {
		super(time, color);
