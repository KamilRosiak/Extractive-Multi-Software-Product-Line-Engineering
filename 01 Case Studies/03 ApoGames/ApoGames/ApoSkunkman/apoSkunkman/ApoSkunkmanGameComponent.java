 ...
 *
 */
public abstract class ApoSkunkmanGameComponent extends ApoSubGame {

	/** Objekt, mit dem mit bestimmten Werten Bilder erstellt und geladen werden können */
	private ApoSkunkmanImages images;
	 ...
	 */
	public ApoSkunkmanGameComponent(ApoScreen screen) {
		super(screen);
	}
	
	@Override
	protected void load() {
		ApoSkunkmanImageContainer.setImages();
		if (this.images == null) {
			this.images = new ApoSkunkmanImages();
		}
	...
	/**
	 * gibt den Filechooser zum Laden/Speichern eines Replays zurück
	 * @return gibt den Filechooser zum Laden/Speichern eines Replays zurück
	 */
	...
	/**
	 * gibt den Filechooser zum Laden/Speichern eines Editorlevel zurück
	 * @return gibt den Filechooser zum Laden/Speichern eines Editorlevels zurück
	 */
	...
	/**
	 * gibt den FileFilter für den Editor zurück
	 * @return gibt den FileFilter für den Editor zurück
	 */
	...
	/**
	 * gibt den FileFilter für das Replay zurück
	 * @return gibt den FileFilter für das Replay zurück
	 */
	...
	public boolean isShowFPS() {
		return ApoSkunkmanConstants.FPS;
	}
	...
	public void setShowFPS(boolean showFPS) {
		ApoSkunkmanConstants.FPS = showFPS;
	}
	 ...
	 */
	public final ApoSkunkmanImages getImages() {
		return this.images;
	}
