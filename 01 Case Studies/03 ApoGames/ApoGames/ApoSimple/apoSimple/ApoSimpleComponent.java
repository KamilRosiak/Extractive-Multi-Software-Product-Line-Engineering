 ...
 *
 */
public abstract class ApoSimpleComponent extends ApoSubGame {

	/** Objekt, mit dem mit bestimmten Werten Bilder erstellt und geladen werden können */
	private ApoSimpleImages images;
	 ...
	 */
	public ApoSimpleComponent(ApoScreen screen) {
		super(screen);
	}
	...
	protected void load() {
		if (this.images == null) {
			this.images = new ApoSimpleImages();
		}
	...
	public void setShowFPS(boolean showFPS) {
		ApoSimpleConstants.FPS = showFPS;
	}
	 ...
	 */
	public final ApoSimpleImages getImages() {
		return this.images;
	}
