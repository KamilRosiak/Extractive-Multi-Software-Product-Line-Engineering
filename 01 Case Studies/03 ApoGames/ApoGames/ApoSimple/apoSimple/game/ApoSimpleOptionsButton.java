 ...
 * @author Dirk Aporius
 */
public class ApoSimpleOptionsButton extends ApoButton {
	
	private boolean bActive;
	
	public ApoSimpleOptionsButton(BufferedImage iImage, float x, float y, float width, float height) {
		this(iImage, (int)x, (int)y, (int)width, (int)height, "", false);
	}
	
	public ApoSimpleOptionsButton(BufferedImage iImage, float x, float y, float width, float height, String description, boolean bActive) {
